...
<body>
		...
		<div class="am-collapse am-topbar-collapse" id="topbar-collapse">
			<ul
				...
				<li class="am-dropdown" data-am-dropdown><a
					...
					href="javascript:;"> ${sessionScope.username } <span
		...
		<div class="admin-sidebar am-offcanvas" id="admin-offcanvas">
			<div class="am-offcanvas-bar admin-offcanvas-bar">
				<ul class="am-list admin-sidebar-list">
					<li><a href="index.jsp"><span class="am-icon-commenting"></span>
							聊天</a></li>
					<li><a href="information.jsp" class="am-cf"><span
					...
					<li class="admin-parent"><a class="am-cf"
						...
						<ul class="am-list am-collapse admin-sidebar-sub am-in"
							id="collapse-nav">
							<li><a href="info-setting.jsp"><span
					...
					<li><a href="log.html"><span class="am-icon-inbox"></span>
							系统日志<span
				...
				<div class="am-tab-panel am-fade am-in am-active" id="tab1">
					<div class="am-g">
						...
						<div class="am-u-md-6" style="float: right">
							<img class="am-circle" src="static/source/img/robot.jpg"
								width="140" height="140" alt="张三" />
						</div>

						<div class="am-u-md-3">
							<b>性别:</b>
						</div>
						<div class="am-u-md-3">${user.sex }</div>
						<div class="am-u-md-3">
							<b>简介:</b>
						</div>
						<div class="am-u-md-3">${user.profile }</div>
						<div class="am-u-md-3">
							<b>注册时间</b>
						</div>
						<div class="am-u-md-3">
							<fmt:formatDate pattern="yyyy-MM-dd" value="${user.firsttime }" />
						</div>
						<div class="am-u-md-3">
							<b>最后登录</b>
						</div>
						<div class="am-u-md-3">
							<fmt:formatDate pattern="yyyy-MM-dd" value="${user.lasttime }" />
						</div>
					</div>
				</div>
			</div>
	...
	<footer style="text-align: center">
		...
		<p class="am-padding-left">
			© 2016 <a href="http://www.qianchengzhidao.com">oracle北京实训基地</a>.
		</p>
	</footer>
</body>
</html>
